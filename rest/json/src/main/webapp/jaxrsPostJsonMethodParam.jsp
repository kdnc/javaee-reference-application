...
<html>
 ...
 JsonArray array = client.target("http://localhost:8080/Rest-Json").path("resources").path("jaxrs").path("post").request(MediaType.APPLICATION_JSON).buildPost(Entity.json(jsonObject)).invoke(JsonArray.class);
